...
noremap \sr :<C-U><C-R>=printf("Leaderf! gtags -r %s --auto-jump", expand("<cword>"))<CR><CR>
noremap \sd :<C-U><C-R>=printf("Leaderf! gtags -d %s --auto-jump", expand("<cword>"))<CR><CR>
noremap \so :<C-U><C-R>=printf("Leaderf! gtags --recall %s", "")<CR><CR>
noremap \sn :<C-U><C-R>=printf("Leaderf gtags --next %s", "")<CR><CR>
noremap \sp :<C-U><C-R>=printf("Leaderf gtags --previous %s", "")<CR><CR>
